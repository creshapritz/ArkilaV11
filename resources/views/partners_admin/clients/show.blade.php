                ...
                <div class="grid">
                    ...
                    @if ($client->driver_front_second_id)
                        <div class="document-item">
                            ...
                            <img src="{{ asset( $client->driver_front_second_id) }}"
                    ...
                    @if ($client->driver_back_second_id)
                        <div class="document-item">
                            ...
                            <img src="{{ asset($client->driver_back_second_id) }}"
                    ...
                    @if ($client->proof_of_billing)
                        <div class="document-item">
                            ...
                            <img src="{{ asset($client->proof_of_billing) }}"
                    ...
                    @if ($client->driver_proof_of_billing)
                        <div class="document-item">
                            ...
                            <img src="{{ asset($client->driver_proof_of_billing) }}"
                                alt="Driver Billing">
                        </div>
                    @endif
                </div>
